...
function pageRevealAnimation() {
  ...
  const target = document.querySelectorAll(".heading-text h1");
  Splitting({ target: target[0], whitespace: true })[0].chars;
  Splitting({ target: target[1], whitespace: true })[0].chars;
  pageRevealTimeline
...
const workPageAnimations = () => {
  ...
  Splitting({ target: aboutHeading, whitespace: true })[0].chars;
